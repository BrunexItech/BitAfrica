    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {[Brain, Cpu, Code, Server, Cloud, Database].map((Icon, i) => (
          ...
          >
            <Icon className="h-12 w-12" style={{ color: colors.techBlue }} />
          </div>
        ))}
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-20 max-w-5xl mx-auto">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-2xl mb-8 overflow-hidden group relative">
            ...
            <span className="text-sm font-bold tracking-widest bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">
          ...
          <h1 className="text-5xl md:text-7xl font-black mb-8 tracking-tight">
            ...
            <span className="block">
              ...
              <span className="text-white/90 ml-4">🚀</span>
            </span>
          </h1>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="card-content relative h-full transform-style-3d transition-transform duration-700">
                ...
                <div className="absolute -inset-0.5 rounded-2xl opacity-70 group-hover:opacity-100 transition-opacity duration-500">
                  <div 
                ...
                >
                  ...
                  <div className="relative mb-6">
                    <div 
                      className="w-16 h-16 rounded-2xl flex items-center justify-center mb-4 transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-12"
                      style={{ background: service.gradient }}
                    >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {service.tech.map((tech, idx) => (
                        <span 
                          key={idx}
                          className="text-xs font-mono px-2 py-1 rounded bg-white/5 border border-white/10 hover:scale-105 transition-transform duration-300"
                  ...
                  <p className="text-blue-100/60 text-sm mb-6 leading-relaxed transition-all duration-500 group-hover:text-blue-100/80 line-clamp-3 group-hover:line-clamp-none">
                    {service.description}
                  </p>
                  ...
                  <div className="mt-auto pt-6 border-t border-white/10">
                    ...
                    {/* Animated CTA button */}
                    <button 
                      className="w-full group/btn relative overflow-hidden rounded-xl py-3 px-4 transition-all duration-500 hover:scale-105"
                      style={{ background: `linear-gradient(90deg, ${service.color}20, ${service.color}10)` }}
                      onMouseEnter={(e) => {
                        e.currentTarget.style.background = service.gradient;
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background = `linear-gradient(90deg, ${service.color}20, ${service.color}10)`;
                      }}
                    >
        ...
        {activeService && (
          <div className="fixed inset-x-4 bottom-4 md:inset-x-auto md:right-4 md:top-1/2 md:transform md:-translate-y-1/2 z-50">
            <div 
              className="relative rounded-2xl p-6 backdrop-blur-2xl border border-white/20 shadow-2xl animate-slideUp"
              style={{
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h4 className="text-lg font-bold text-white">Selected Service</h4>
                <button 
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h5 className="font-bold text-white">{activeService.title}</h5>
                    <div className="text-sm text-white/60">{activeService.delivery} delivery</div>
                  </div>
                </div>
                
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 rounded-lg bg-white/5">
                    <div className="text-2xl font-bold text-white">{activeService.stats.projects}+</div>
                    <div className="text-xs text-white/60">Successful Projects</div>
                  </div>
                  <div className="p-3 rounded-lg bg-white/5">
                    <div className="text-2xl font-bold text-white">{activeService.stats.satisfaction}%</div>
                    <div className="text-xs text-white/60">Client Satisfaction</div>
                  </div>
                </div>
                
                <button className="w-full py-3 rounded-xl font-semibold text-white transition-all duration-300 hover:scale-105"
                  style={{ background: activeService.gradient }}
                >
                  Request Proposal
                </button>
        ...
        <div className="relative rounded-3xl overflow-hidden mt-32">
          {/* Particle background */}
          ...
          >
            ...
            <p className="text-xl text-blue-100/80 mb-8 max-w-2xl mx-auto">
              Let's discuss how our cutting-edge services can transform your business vision into reality.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="group relative px-8 py-4 rounded-2xl overflow-hidden transition-all duration-500 hover:scale-105">
                <div 
                  className="absolute inset-0 rounded-2xl"
                  style={{
              ...
              <button className="group px-8 py-4 rounded-2xl border-2 border-white/20 hover:border-white/40 bg-white/5 hover:bg-white/10 backdrop-blur-lg transition-all duration-500 hover:scale-105">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-6 text-blue-100/60">
