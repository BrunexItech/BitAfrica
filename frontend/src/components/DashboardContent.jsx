...
const DashboardContent = ({
  ...
  // View states - simplified approach
  const [currentView, setCurrentView] = useState('dashboard'); // 'dashboard', 'learning', 'quiz'
  ...
  // Reset all states when returning to dashboard
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className={`rounded-xl p-6 mb-6 ${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg border ${darkMode ? 'border-gray-700' : 'border-gray-200'} select-none`}>
            <div className="flex flex-col md:flex-row md:items-start justify-between mb-4">
              ...
              <div className={`px-4 py-2 rounded-lg ${courseColor.light} border ${courseColor.border} select-none`}>
                <span className={`font-medium ${darkMode ? 'text-gray-200' : 'text-gray-800'} select-none`}>{selectedCourse.category}</span>
              </div>
            </div>
  ...
  return (
    <div className="flex select-none">
      ...
      <main className={`flex-1 p-4 md:p-6 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'} select-none`}>
        ...
        {/* Search and Filter - WITH SEARCH BUTTON */}
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-2 select-none">
              ...
              <div className="relative">
                ...
                {showSortOptions && (
                  <div className={`absolute left-0 right-0 mt-1 rounded-lg shadow-lg border py-1 z-50 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} select-none`}>
                    <button
                      onClick={() => { setSortBy('alphabetical'); setShowSortOptions(false); }}
                      className={`flex items-center w-full px-3 py-2 text-left text-sm ${darkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-50'} ${sortBy === 'alphabetical' ? (darkMode ? 'bg-blue-900/30 text-blue-300' : 'bg-blue-50 text-blue-700') : (darkMode ? 'text-gray-300' : 'text-gray-700')} select-none`}
                    >
                    ...
                    <button
                      ...
                      className={`flex items-center w-full px-3 py-2 text-left text-sm ${darkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-50'} ${sortBy === 'progress' ? (darkMode ? 'bg-blue-900/30 text-blue-300' : 'bg-blue-50 text-blue-700') : (darkMode ? 'text-gray-300' : 'text-gray-700')} select-none`}
                    >
                    ...
                    <button
                      ...
                      className={`flex items-center w-full px-3 py-2 text-left text-sm ${darkMode ? 'hover:bg-gray-700' : 'hover:bg-gray-50'} ${sortBy === 'recent' ? (darkMode ? 'bg-blue-900/30 text-blue-300' : 'bg-blue-50 text-blue-700') : (darkMode ? 'text-gray-300' : 'text-gray-700')} select-none`}
                    >
        ...
        {/* Courses Section - VERTICAL LAYOUT */}
        <div className="mb-8 select-none">
            ...
            <div className="space-y-4 select-none">
              {filteredCourses.map((course) => {
                ...
                return (
                  <div
                    key={course.id}
                    className={`rounded-xl border ${darkMode ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-white'} p-6 transition-all hover:shadow-xl select-none`}
                  >
                    <div className="flex flex-col lg:flex-row lg:items-start gap-6">
                      {/* Course Info - Left Side */}
                      <div className="flex-1">
                        <div className="flex items-start mb-4">
                          <div className={`p-3 rounded-lg ${courseColor.light} border ${courseColor.border} mr-4 select-none`}>
                            {courseColor.icon}
                          </div>
                          <div className="flex-1">
                            <div className="flex flex-wrap items-center gap-2 mb-3 select-none">
                              <span className={`text-xs font-semibold px-3 py-1.5 rounded-full flex items-center ${statusBadge.className} select-none`}>
                                {statusBadge.icon}
                                {statusBadge.text}
                              </span>
                              <span className={`text-xs px-3 py-1.5 rounded-full ${darkMode ? 'bg-gray-700 text-gray-300' : 'bg-gray-100 text-gray-700'} select-none`}>
                                {course.category}
                              </span>
                              <span className={`text-xs px-3 py-1.5 rounded-full ${darkMode ? 'bg-gray-700 text-gray-300' : 'bg-gray-100 text-gray-700'} select-none`}>
                            ...
                            <h3 className={`text-xl font-bold mb-3 ${darkMode ? 'text-white' : 'text-gray-900'} select-none`}>{course.title || 'Untitled Course'}</h3>
                            <p className={`text-sm mb-5 ${darkMode ? 'text-gray-300' : 'text-gray-700'} line-clamp-2 select-none`}>
                        ...
                        <div className="mb-4 select-none">
                          <div className="flex justify-between text-sm mb-1 select-none">
                            <span className={darkMode ? 'text-gray-400' : 'text-gray-600'}>Progress</span>
                            <span className={`font-medium ${darkMode ? 'text-gray-300' : 'text-gray-700'} select-none`}>{Math.round(progressPercentage)}%</span>
                          </div>
                          <div className={`h-2 rounded-full ${darkMode ? 'bg-gray-700' : 'bg-gray-200'}`}>
                            <div 
                          ...
                          <div className={`flex justify-between text-xs mt-1 ${darkMode ? 'text-gray-400' : 'text-gray-600'} select-none`}>
                      ...
                      <div className="lg:w-64 flex flex-col gap-3 select-none">
                        <button
                          onClick={() => startLearning(course.id)}
                          className="px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800 transition-colors flex items-center justify-center text-sm font-medium shadow-md select-none"
                        >
                        ...
                        {(course.completed_modules || 0) > 0 && (
                          <button
                            ...
                            className="px-4 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 dark:bg-purple-700 dark:hover:bg-purple-800 transition-colors flex items-center justify-center text-sm font-medium shadow-md select-none"
                          >
